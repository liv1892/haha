...
esp_err_t ble_write(uint8_t *value,uint16_t value_len)
{
	...
	if(conn_device_b == true && get_service_b == true){
		ret=esp_ble_gattc_write_char( gl_profile_tab[PROFILE_B_APP_ID].gattc_if,
		                                  gl_profile_tab[PROFILE_B_APP_ID].conn_id,
		                                  gl_profile_tab[PROFILE_B_APP_ID].char_handle,
		                                  value_len,
		                                  value,
	...
	if(conn_device_c == true && get_service_c == true){
		ret=esp_ble_gattc_write_char( gl_profile_tab[PROFILE_C_APP_ID].gattc_if,
		                                  gl_profile_tab[PROFILE_C_APP_ID].conn_id,
		                                  gl_profile_tab[PROFILE_C_APP_ID].char_handle,
		                                  value_len,
		                                  value,
